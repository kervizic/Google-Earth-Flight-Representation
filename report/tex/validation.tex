...
A partir des tests réalisés et de la validation avec le client comme cité précedement nous redéfinissons les besoins ainsi que les spécifications. Cela nous amène donc à revenir au cycle des besoins \nref{besoins} dans notre méthode de gestion de projet \nref{extreme}.
