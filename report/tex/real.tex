...
Plusieurs conventions on du être acquise comme celle utilisée par le système \textsc{Tiare} pour décrir les reports \textsc{Ads} ou encre celle utilisée par les compagnies pour le dépôt de plans de vol \bibref{doc4444}.
